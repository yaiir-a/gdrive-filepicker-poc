...
var developerKey = 'AIzaSyBk1qIWkC-MQU-Z42gxG9d8phDW46vycAc';

// The Client ID obtained from the Google API Console. Replace with your own Client ID.
var clientId = '439872824072-qmoiuvtjor9ftqudi1ft91bhjbiuvqrv.apps.googleusercontent.com';
...
function createPicker() {
  if (pickerApiLoaded && oauthToken) {
    var picker = new google.picker.PickerBuilder().
        ...
        addView(google.picker.ViewId.DocsUploadView).
